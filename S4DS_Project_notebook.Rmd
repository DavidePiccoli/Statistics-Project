...
This notebook aims to investigate and recreate the advancements brought about by the Kolmogorov-Smirnov (KS) test in statistical analysis. It will specifically compare the KS test with the Chi-square test in the context of examining discrete distributions.

# Binning

In this notebook we are using the four_categories and ten_categories functions as in the paper, for both KS and Chi-square.
